...
class Usuario:
    def __init__(self, apellido=None, nombre=None, email=None, fecha_nacimiento=None, clave=None, genero=None, id_usuario=None):
    ...
    def get_all():
        ...
        usuarios = [  Usuario(id_usuario=row[0], apellido=row[1], nombre=row[2], email=row[3], fecha_nacimiento=row[4], clave=row[5], genero=row[6]) for row in rows] # type: ignore
        cursor.close()
        return usuarios
